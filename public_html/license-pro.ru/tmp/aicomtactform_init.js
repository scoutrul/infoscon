		...
		$('adminForm_'+pf).addEvent('submit', function(e) {
			...
			this.send({
				onRequest: function(){ 
										...
										$('aiContactSafeSend_loading_'+pf).setHTML('&nbsp;&nbsp;Пожалуйста, подождите ...&nbsp;<img id="imgLoading" border="0" src="http://license-pro.ru/components/com_aicontactsafe/includes/images/load.gif" />&nbsp;&nbsp;');
	...
	function changeCaptcha( pf, modifyFocus ) {
		if (document.getElementById('div_captcha_img_'+pf)) {
			...
			var captcha_file = 'http://license-pro.ru/index.php?option=com_aicontactsafe&sTask=captcha&task=captcha&pf='+pf+'&r_id='+r_id+'&lang=en&format=raw&set_rand='+set_rand;
			if (window.ie6) {
				var url = 'http://license-pro.ru/index.php?option=com_aicontactsafe&sTask=captcha&task=newCaptcha&pf='+pf+'&r_id='+r_id+'&lang=en&format=raw&set_rand='+set_rand;
				new Ajax(url, {
					method: 'get',
	...
	function deleteUploadedFile(file_field, pf) {
		...
		var r_id = document.getElementById('adminForm_'+pf).elements['r_id'].value;
		var url = 'http://license-pro.ru/index.php?option=com_aicontactsafe&sTask=message&task=deleteUploadedFile&filename='+file_name+'&r_id='+r_id+'&format=raw'
